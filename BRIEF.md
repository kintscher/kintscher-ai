...
Then propose 2–3 distinct design directions for kintscher.ai. For each: a name,
the rationale, the type system, the color palette, the motion language, and
one rough page-layout sketch in prose.
Do NOT write any code yet. After you propose, I'll pick one direction.
